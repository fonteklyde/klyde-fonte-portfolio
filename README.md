...
- **📁 Content Collections**:
  - **Projects (`src/content/projects/`)**: Detailed Markdown data case studies (*Counter-Strike GOAT Analysis*, *Long-Term Casino Player Analysis*, *Water Potability Prediction & Analysis*, and *DevPath*) with key analytical insights, statistical findings, technical architecture decisions, tag metadata, and visualization galleries.
...
│   └── images/                      # Project screenshots, certificate badges, & case study visualizations (CS GOAT & Casino)
├── src/
